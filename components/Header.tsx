...
import { Flame, Cookie, HeartCrack } from "lucide-react";
...
export function Header() {
  ...
  return (
    <nav className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
      <div className="pointer-events-auto bg-white/90 backdrop-blur-md border border-gray-200 shadow-xl rounded-full p-1.5 flex gap-1">
        {menu.map((item) => {
